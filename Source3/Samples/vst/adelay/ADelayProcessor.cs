...
namespace Jacobi.Vst3.TestPlugin
{
    ...
    {
        protected ParamValue mDelay = 1;
        protected float** mBuffer = null;
        protected int mBufferPos = 0;
        protected bool mBypass = false;
        ...
        {
            ControlledClassId = typeof(IDelayTestController).GUID;
