...
namespace Steinberg.Vst3
{
    ...
    public struct ParameterInfo
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Platform.Fixed128)] public String Title;       // parameter title (e.g. "Volume")
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Platform.Fixed128)] public String ShortTitle;  // parameter shortTitle (e.g. "Vol")
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Platform.Fixed128)] public String Units;       // parameter unit (e.g. "dB")
    ...
    public interface IEditController : IPluginBase
    {
        ...
        TResult GetParamStringByValue(
            [MarshalAs(UnmanagedType.U4), In] UInt32 paramId,
            [MarshalAs(UnmanagedType.R8), In] Double valueNormalized,
            [MarshalAs(UnmanagedType.LPWStr, SizeConst = Platform.Fixed128), Out] StringBuilder @string);
        ...
        TResult GetParamValueByString(
            [MarshalAs(UnmanagedType.U4), In] UInt32 paramId,
            [MarshalAs(UnmanagedType.LPWStr, SizeConst = Platform.Fixed128), In] String @string,
