...
//                _audioBuffers = &processData.Inputs[busIndex];
//            }
//            else
//            {
//                Guard.ThrowIfOutOfRange(nameof(busIndex), busIndex, 0, processData.NumOutputs);
//                _audioBuffers = &processData.Outputs[busIndex];
//            }
//        }
...
//            return _audioBuffers->ChannelBuffers32X != IntPtr.Zero && !IsChannelSilent(channelIndex)
//                ? _audioBuffers->ChannelBuffers32[channelIndex]
//                : (float*)null;
//        }
...
//            return _audioBuffers->ChannelBuffers64X != IntPtr.Zero && !IsChannelSilent(channelIndex)
//                ? _audioBuffers->ChannelBuffers64[channelIndex]
//                : (double*)null;
//        }
//    }
//}
