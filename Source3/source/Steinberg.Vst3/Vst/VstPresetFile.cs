...
namespace Steinberg.Vst3
{
    ...
    */
    ...
    public unsafe class PresetFile
    {
        ...
        public static ref ChunkID GetChunkID(ChunkType type)
            => ref commonChunks[(int)type];

        public static bool IsEqualID(ChunkID id1, ChunkID id2)
            => id1 == id2;

        static bool Verify(TResult result)
        ...
        public PresetFile(IBStream stream)
        {
            this.stream = stream;
        ...
        public void SetClassID(Guid uid)
            => classID = uid;
        ...
        /// <returns></returns>
        public Entry GetEntry(ChunkType which)
        {
        ...
        /// <param name="which"></param>
        /// <returns></returns>
        public bool Contains(ChunkType which)
            => GetEntry(which) != null;
        ...
        #region for storing and restoring the whole plug-in state (component and controller states)

        /// <summary>
        /// Seeks to the begin of the Component State.
        /// </summary>
        /// <returns></returns>
        public bool SeekToComponentState()
        {
        ...
        /// <returns></returns>
        public bool StoreComponentState(IComponent component)
        {
        ...
        /// </summary>
        /// <param name="componentStream"></param>
        /// <returns></returns>
        public bool StoreComponentState(IBStream componentStream)
        {
            if (Contains(kComponentState)) // already exists!
                return false;
        ...
        /// <param name="component"></param>
        /// <returns></returns>
        public bool RestoreComponentState(IComponent component)
        {
            var e = GetEntry(kComponentState);
            if (e == null)
                return false;
        ...
        /// </summary>
        /// <param name="editController"></param>
        /// <returns></returns>
        public bool RestoreComponentState(IEditController editController)
        {
            var e = GetEntry(kComponentState);
            if (e != null)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public bool SeekToControllerState()
        {
        ...
        /// <param name="editController"></param>
        /// <returns></returns>
        public bool StoreControllerState(IEditController editController)
        {
        ...
        /// </summary>
        /// <param name="editStream"></param>
        /// <returns></returns>
        public bool StoreControllerState(IBStream editStream)
        {
            if (Contains(kControllerState)) // already exists!
                return false;
        ...
        /// <param name="editController"></param>
        /// <returns></returns>
        public bool RestoreControllerState(IEditController editController)
        {
            var e = GetEntry(kControllerState);
            if (e != null)
            {
        ...
        /// <param name="listID">could be ProgramListID or UnitID.</param>
        /// <returns></returns>
        ...
        /// <param name="unitProgramListID"></param>
        /// <param name="programIndex"></param>
        /// <returns></returns>
        ...
        /// <param name="component"></param>
        /// <param name="editController"></param>
        /// <param name="otherClassIDArray"></param>
        /// <returns></returns>
    ...
    {
        protected IBStream sourceStream;
        protected TSize sourceOffset;
        protected TSize sectionSize;
        protected TSize seekPosition;
        ...
        //public TResult queryInterface (Guid iid, void** obj)
        //=> sourceStream ? sourceStream->queryInterface(iid, obj) : kResultFalse;
    ...
    {
        protected MemoryStream mBuffer = new();
