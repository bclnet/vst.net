...
namespace Steinberg.Vst3
{
    unsafe static partial class Helpers
    {
        ...
        public static byte BoundTo(byte minval, byte maxval, byte x) => x < minval ? minval : x > maxval ? maxval : x;
        /// <summary>
        /// bound a value between a min and max
        /// </summary>
        /// <param name="minval"></param>
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float BoundTo(float minval, float maxval, float x) => x < minval ? minval : x > maxval ? maxval : x;
        /// <summary>
        /// bound a value between a min and max
        /// </summary>
        /// <param name="minval"></param>
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static double BoundTo(double minval, double maxval, double x) => x < minval ? minval : x > maxval ? maxval : x;
