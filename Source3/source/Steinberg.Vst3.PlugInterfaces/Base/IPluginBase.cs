...
namespace Steinberg.Vst3
{
    ...
    public struct PClassInfo
    {
        ...
        public static implicit operator PClassInfo(PClassInfo2 _)
            => new()
            {
                Cid = _.Cid,
    ...
    {
        public static implicit operator PClassInfo2(PClassInfo _)
            => new()
            {
                Cid = _.Cid,
                Cardinality = _.Cardinality,
    ...
    public struct PClassInfoW
    {
        ...
        public void FromAscii(ref PClassInfo2 ci2)
        {
            Cid = ci2.Cid;
            Cardinality = ci2.Cardinality;
            Category.Value = ci2.Category;
            Name = ci2.Name;
            ClassFlags = ci2.ClassFlags;
            SubCategories.Value = ci2.SubCategories;
