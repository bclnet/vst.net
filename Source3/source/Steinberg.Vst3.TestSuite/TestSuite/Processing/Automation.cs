...
namespace Steinberg.Vst3.TestSuite
{
    ...
    public class FlushParamTest : AutomationTest
    {
        ...
        protected virtual void PrepareProcessData()
        {
            ...
            processData._.InputsX = IntPtr.Zero;
            processData._.OutputsX = IntPtr.Zero;
        }
    ...
    public unsafe class FlushParamTest2 : FlushParamTest
    {
        ...
        protected override void PrepareProcessData()
        {
            ...
            if (processData._.InputsX != IntPtr.Zero) FUtils.Swap<int>(ref numChannelsIn, ref processData._.Inputs[0].NumChannels);
            if (processData._.OutputsX != IntPtr.Zero) FUtils.Swap<int>(ref numChannelsOut, ref processData._.Outputs[0].NumChannels);
        }
