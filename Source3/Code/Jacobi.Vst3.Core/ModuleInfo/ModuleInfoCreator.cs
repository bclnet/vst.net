...
namespace Jacobi.Vst3.Core.ModuleInfo
{
    public partial class ModuleInfoLib
    {
        ...
        static void WritePluginCompatibility(List<ModuleInfo.Compatibility_> cls, Utf8JsonWriter w)
        {
            if (!cls.Any()) return;
        ...
        static void WriteFactoryInfo(ModuleInfo.FactoryInfo_ fi, Utf8JsonWriter w)
        {
        ...
        static ModuleInfo CreateModuleInfo(Module module, bool includeDiscardableClasses)
        {
            ...
            {
                Name = module.Name,
                FactoryInfo = new ModuleInfo.FactoryInfo_
                {
